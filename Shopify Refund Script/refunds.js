...
const notification = (el, b, c, p, ta) => {
...
const qty = document.querySelectorAll(".Polaris-Card__Section_1b1h1 ul > li");
    ...
    refundShipping.forEach((el) => {
        ...
        if (header) {
            if (header.textContent == "Refund shipping") {
                ...
                notification(refundcash.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement, "Test", 2);
